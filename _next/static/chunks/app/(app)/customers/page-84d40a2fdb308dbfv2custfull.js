...
return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsxs)("tr",{className:"hover:bg-slate-50",children:[
  ...
  (0,a.jsx)("td",{className:"hidden md:table-cell cursor-pointer",onClick:b,children:(0,a.jsxs)("span",{className:"badge ".concat(t.loyalty_points>0?"bg-indigo-50 text-indigo-700":"bg-slate-100 text-slate-400"),children:["🎁 ",t.loyalty_points]})}),
  s&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("td",{className:"font-semibold text-indigo-600 cursor-pointer",onClick:b,children:(0,i.tN)(t.total_spent)}),(0,a.jsx)("td",{className:"hidden md:table-cell text-slate-500 text-sm cursor-pointer",onClick:b,children:t.order_count})]}),
...
return(0,a.jsxs)("div",{className:"p-4 lg:p-6 space-y-4",children:[
  ...
  (0,a.jsx)("div",{className:"card p-0 overflow-x-auto",children:(0,a.jsxs)("table",{children:[(0,a.jsx)("thead",{children:(0,a.jsxs)("tr",{children:[(0,a.jsx)("th",{children:"العميل"}),(0,a.jsx)("th",{children:"الهاتف"}),(0,a.jsx)("th",{className:"hidden md:table-cell",children:"النقاط"}),p&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("th",{children:"إجمالي الإنفاق"}),(0,a.jsx)("th",{className:"hidden md:table-cell",children:"الفواتير"})]}),(0,a.jsx)("th",{className:"hidden sm:table-cell",children:"آخر زيارة"}),(0,a.jsx)("th",{})]})}),
